    ...
    return (
        <>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start relative">
                ...
                {/* 1. Service Form (Mobile: Top | Desktop: Left, Row 1) */}
                ...
                {/* 2. Live Preview (Mobile: Middle | Desktop: Right, Sticky, Full Height) */}
                <div className="w-full lg:col-start-2 lg:row-start-1 lg:row-span-full lg:sticky lg:top-20">
                    ...
                    <div className="border-4 border-gray-200 rounded-xl overflow-hidden bg-white shadow-xl">
                        ...
                        <div className="max-h-[50vh] lg:max-h-[75vh] overflow-y-auto bg-gray-50 custom-scrollbar relative">
                             {/* Preview Overlay Label */}
                            <div className="absolute top-2 right-2 bg-black/10 text-black/50 text-xs font-bold px-2 py-1 rounded pointer-events-none">PREVIEW</div>
                ...
                {/* 3. Existing Services List (Mobile: Bottom | Desktop: Left, Row 2) */}
                <div className="w-full lg:col-start-1 mt-8 lg:mt-0">
